...
public abstract class Mob extends Entity {
	...
	// An enumeration to represent direction. Instead of using integers to represent
	// direction, which can be confusing, we can assign names to these integers, such
	// as up, down, left and right. This allows us to refer to direction using English
	// rather than numbers.
	protected enum Direction {
		UP, DOWN, LEFT, RIGHT
	}

	// A variable is created to keep track of the Mob's current direction, as set
	// in the move() method.
